  ...
  \cventry
    ...
    {January 2024 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item \textbf{Tech stack:} Golang, Redis, Apache Druid
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {May 2021 - March 2023} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item \textbf{Tech stack:} Apache Kafka, Apache Druid, Apache Kudu, Spring Boot, Elasticsearch, MongoDB, Cassandra, Redis, JUnit, Kubernetes
      \end{cvitems}
    }
