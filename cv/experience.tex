  ...
  \cventry
    ...
    {March 2023 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item developing and maintaining Ramzinex trading core, which is one of the most extensive crypto exchanges in Iran with about 1M monthly active users
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item developing and maintaining a Data Platform with about 10 \textbf{microservices}, which handles requests for more than 40M monthly users, with \textbf{Kotlin} and 
    ...
    { 
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \\ Telfa, an application with more than 1M downloads in google play, is a fork from the telegram open source project
